...
Namespace Eml
	...
	Public Class EmlDocumentImporter
        ...
        Public Function LoadDocument(ByVal documentModel As DevExpress.Office.IDocumentModel, ByVal stream As Stream, ByVal options As IImporterOptions) As Boolean _
