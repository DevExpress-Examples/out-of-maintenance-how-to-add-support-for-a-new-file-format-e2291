...
Namespace Eml
	...
	Public Class EmlDocumentImporter
        ...
        Public ReadOnly Property Filter() As FileDialogFilter Implements IImporter(Of DevExpress.XtraRichEdit.DocumentFormat, Boolean).Filter
            Get
                Return EmlDocumentExporter.filter_Renamed
            End Get
        End Property
        Public ReadOnly Property Format() As DocumentFormat Implements IImporter(Of DevExpress.XtraRichEdit.DocumentFormat, Boolean).Format
            Get
                Return EmlDocumentFormat.Id
            End Get
        End Property
        Public Function SetupLoading() As IImporterOptions Implements IImporter(Of DevExpress.XtraRichEdit.DocumentFormat, Boolean).SetupLoading
